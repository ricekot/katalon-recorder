...
if (!this.formatterType) {  // this.formatterType is defined for the new Formatter system
  ...
  options.header =
      ...
      indents(4) + "getExtensionLoader().getExtension(\n" +
      indents(5) + "org.zaproxy.zap.extension.selenium.ExtensionSelenium.class);\n" +
      "\n" +
      "var driver = extSel.getWebDriverProxyingViaZAP(1, \"firefox\");\n";
